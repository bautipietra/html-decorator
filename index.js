...
function typeMark(el, color) {
  ...
  mark.style.cssText = `left: 0;  top: 50%; transform: translate(-120%, -50%); position: absolute; width: 30%; height: 3px; background-color: ${color};`
  el.style.cssText += 'position: relative; transform: translateX(60%); width: fit-content;';
  el.appendChild(mark);
}
