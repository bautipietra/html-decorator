...
function typeArrowToTop(el, color) {
  const svg = `
                    <svg class="w-10 h-10" viewBox="0 0 77 85" fill="none" xmlns="http://www.w3.org/2000/svg" style="position: absolute; height: ${el.offsetHeight}px; width: ${el.offsetHeight}px; top: 110%; left: 0">
